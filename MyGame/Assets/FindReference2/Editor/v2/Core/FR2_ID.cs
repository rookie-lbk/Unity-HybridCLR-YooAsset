...
namespace vietlabs.fr2
{
   ...
   [Serializable] 
   public struct FR2_ID: IEquatable<FR2_ID>
   {
       ...
       private FR2_ID(int pValue)
       {
           value = pValue;
       }
       
       public FR2_ID(int mainIndex, int subIndex, bool isSceneObject)
       {
       ...
       [MethodImpl(MethodImplOptions.AggressiveInlining)]
       public FR2_ID WithoutSubAssetIndex() => WithSubAssetIndex(0);
       
       [MethodImpl(MethodImplOptions.AggressiveInlining)]
       public FR2_ID WithSubAssetIndex(int subIndex)
       {   
           return new FR2_ID(MainIndex, subIndex, IsSceneObject);
       }
       ...
       public static implicit operator int(FR2_ID id) => id.value;
       public static implicit operator FR2_ID(int value) => new FR2_ID(value);

       public override int GetHashCode() => value;
       public bool Equals(FR2_ID other) => value == other.value;
       public override bool Equals(object obj) => obj is FR2_ID other && Equals(other);
       ...
       // private sealed class Comparer : IEqualityComparer<FR2_ID>
       // {
       //     public static readonly Comparer Instance = new Comparer();
       //     public bool Equals(FR2_ID x, FR2_ID y) => x.serializedValue == y.serializedValue;
       //     public int GetHashCode(FR2_ID obj) => obj.serializedValue;
       // }
   }
}