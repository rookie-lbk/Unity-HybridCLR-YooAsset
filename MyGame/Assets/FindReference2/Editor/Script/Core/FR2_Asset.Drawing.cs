...
namespace vietlabs.fr2
{
    internal partial class FR2_Asset
    {
        ...
        )
        {
            ...
            {
                Rect pingRect = iconRect; //FR2_Setting.PingRow ? new Rect(0, r.y, r.x + r.width, r.height) : 
            ...
            if (singleLine)
            {
                ...
                {
                    GUI.Label(lbRect, FR2_GUIContent.FromString(assetName), EditorStyles.label);
                }
            ...
            {
                if (cfg.drawPath) GUI.Label(new Rect(r.x, r.y + 16f, r.width, r.height), FR2_GUIContent.FromString(m_assetFolder), EditorStyles.miniLabel);
        ...
        internal void Ping()
        {
            if (EditorWindow.focusedWindow is FR2_WindowAll fr2Window)
            {
                fr2Window.smartLock.SetPingLockState(FR2_SmartLock.PingLockState.Asset);    
            }
