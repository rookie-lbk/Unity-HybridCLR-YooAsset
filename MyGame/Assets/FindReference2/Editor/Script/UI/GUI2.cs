...
namespace vietlabs.fr2
{
    ...
    internal static class GUI2
    {
        ...
        {
            GUIContent guiContent = FR2_GUIContent.From(label);
        ...
        {
            //TODO: FIX GC
            bool vv = GUI.Toggle(r, value, FR2_GUIContent.Tooltip(tooltip), EditorStyles.toolbarButton);
        ...
        internal static bool ToolbarToggle(ref bool value, Texture icon, Vector2 padding, string tooltip = null)
        {
            ...
            {
                vv = GUILayout.Toggle(value, FR2_GUIContent.Tooltip(tooltip), EditorStyles.toolbarButton, GLW_24);
                if (icon != null)
                {
                    Rect rect = GUILayoutUtility.GetLastRect();
                    rect = Padding(rect, padding.x, padding.y);
