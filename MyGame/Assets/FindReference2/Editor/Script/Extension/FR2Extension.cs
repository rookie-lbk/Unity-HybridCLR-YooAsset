...
namespace vietlabs.fr2
{
    internal static class GUIExtension
    {
        ...
        {
            return DrawLabel(rect, FR2_GUIContent.FromString(label), EditorStyles.label, color, true, drawCondition);
        }

        public static Rect RDrawLabel(this Rect rect, string label, Color? color = null, bool drawCondition = true)
        {
            return DrawLabel(rect, FR2_GUIContent.FromString(label), EditorStyles.label, color, false, drawCondition);
        }
        ...
        {
            return LDrawMiniLabel(rect, FR2_GUIContent.FromString(label), color, drawCondition);
        }
        ...
        {
            return RDrawMiniLabel(rect, FR2_GUIContent.FromString(label), color, drawCondition);
        }
